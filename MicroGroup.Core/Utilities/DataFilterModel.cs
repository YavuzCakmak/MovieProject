...
namespace MicroGroup.Core.Utilities
{
    public class DataFilterModel : DataFilterModel<FilterTerm, SortTerm>
    {
    }
    public class DataFilterModel<TFilterTerm, TSortTerm> : ISieveModel<TFilterTerm, TSortTerm>
